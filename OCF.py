...
class OCF(nn.Module):
    ...
    def __init__(self, c1, level=0):
        ...
        self.ocf_cat = ocf_cat(8,8)
        self.ocf_catcon = nn.Conv2d(8, 16, 1, 1)
    ...
    def forward(self, x):
        ...
        levels_weight_v=self.ocf_cat(level_0_weight_v,level_1_weight_v)
        levels_weight_v=self.ocf_catcon(levels_weight_v)         
